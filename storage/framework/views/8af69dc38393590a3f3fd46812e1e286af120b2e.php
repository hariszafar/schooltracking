                        ...
                        <table id="example1" class="table table-bordered table-striped table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e(trim($schoolRow->schoolAddress)); ?></td>
                                    <td><?php echo e($schoolRow->schoolNumber); ?></td>
                                    <td><?php echo e($schoolRow->principle->name); ?></td>
                                    <td><?php echo e($schoolRow->principle->assignedBuses); ?></td>
                                    <td><?php echo e($schoolRow->principle->busCount); ?></td>
                                    <td>
                                        <div class="btn-group">
